...
import static com.suduku.util.BoardTemplate.BOARD_TEMPLATE;
...
public class Main {
    ...
    private static void startGame(Map<String, String> positions) {
        if (nonNull(board)) {
            System.out.println("O jogo já foi inicializado!");
            return;
        }
    ...
    private static void showCurrentGame() {
        ...
        System.out.println("Su jogo se encontra da seguinte forma");
